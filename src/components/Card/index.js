                    ...
                    <div className="inline-flex p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md" style={{ padding: 10 }}>
                            <div>
                                ...
                                <div class="inline-flex" role="group">
                                    <button onClick={() => {handleOpen(); console.log("id yg dipilih", item.id)}} type="button" class="text-red-700 hover:text-white border-2 border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
